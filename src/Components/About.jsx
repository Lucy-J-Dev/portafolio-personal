  ...
  return (
    <div id="about" className="container about">
      ...
      <p>
        ...
        developer, I bring a unique perspective to my work. My expertise lies in
        crafting intuitive user experiences using HTML, CSS, JavaScript, and
        React. I believe that understanding human behavior is crucial in
        creating engaging and accessible web applications.
      </p>

      <p>
        In my projects, I focus on clean code and responsive design, ensuring
        that users have a seamless experience across devices. I enjoy leveraging
        tools like GitHub for version control, which enhances collaboration and
        project management. My goal is to create visually appealing and
        functional websites that meet the needs of users and clients alike.
      </p>
      ...
      <p>
        ...
        browse through my work and see how I can help bring your ideas to life.
      </p>
      ...
      <p>
        Thank you for visiting my portfolio. Lets connect and discuss how we can
